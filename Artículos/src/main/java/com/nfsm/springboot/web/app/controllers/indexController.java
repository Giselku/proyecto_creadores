...
public class indexController {
	...
	public String listar(Model model) {
		...
		producto.add(
				new Productos("Zucaritas", "Hojuelas de maíz con azúcar adicionadas con complejo B, hierro y zinc.",
						"$46.90", "Kellogg’s ", "460 g.", "Kellogg’s"));
